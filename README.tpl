...
[Source https://github.com/kolbma/rs_rqlite_client/tree/v{{version}}](https://github.com/kolbma/rs_rqlite_client/tree/v{{version}})  
[Download https://github.com/kolbma/rs_rqlite_client/releases/tag/v{{version}}](https://github.com/kolbma/rs_rqlite_client/releases/tag/v{{version}})
